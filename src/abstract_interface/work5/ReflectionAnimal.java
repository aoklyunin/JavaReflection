package abstract_interface.work5;

import abstract_interface.work4.Vehicle;
import customReflection.MyReflection;


public class ReflectionAnimal {
    public static void main(String[] args) {

        MyReflection.setInterfaceClass(Animal.class);
        ...
        MyReflection.checkDeclaringMethod("speak").check(String.class);
