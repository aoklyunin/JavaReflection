package abstract_interface.work4;

import abstract_interface.work3.TestInterface;
import customReflection.MyReflection;


public class ReflectionVehicle {
    public static void main(String[] args) {

        MyReflection.setInterfaceClass(Vehicle.class);
        ...
        MyReflection.checkDeclaringMethod("accelerate", new Class[]{int.class}).check(void.class);
        MyReflection.separate();
        MyReflection.checkDeclaringMethod("brake").check(void.class);
        MyReflection.separate();
        MyReflection.checkDeclaringMethod("horn").check(void.class);
