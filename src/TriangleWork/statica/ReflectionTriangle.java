...
public class ReflectionTriangle {
    public static void main(String[] args) {
        ...
        MyReflection.setClass(Triangle.class);

        setField("a",5,2);
        setField("b",1,2);
        setField("c",5,2);

        MyReflection.getField("a").check(double.class, MyReflection.MODIFIER_PRIVATE);
        MyReflection.getField("b").check(double.class, MyReflection.MODIFIER_PRIVATE);
        MyReflection.getField("c").check(double.class, MyReflection.MODIFIER_PRIVATE);
