...
public class ReflectionText {
    static Text rect = new Text();
    static Text rect2 = new Text();
    ...
    public static void main(String[] args) {
        setField("text","","","text1","text2");


        checkStringField("text","find field 'text'","no field 'text'");


        System.out.println(checkConstructor("", "no method 'Text()'", new Runnable() {
            @Override
            public void run() {

            }
        }));
        dispRetObjects(checkConstructor("", "no method 'Text(String s)'",
        ...
        checkMethod("appendText","","no method 'appendText(String s)'",
                new Class[] { String.class},
