 ...
 */
public class ReflectionMan {
    static Man rect = new Man();
    static Man rect2 = new Man();
    ...
    public static void main(String[] args) {
        setField("name","","","Иван","Татьяна");
        setField("age","","",18,45);
        setField("male","","",false,true);
        setField("weight","","",60.1,75.1);


        checkStringField("name","find field 'name'","no field 'name'");
        checkIntegerField("age","find field 'age'","no field 'age'");
        checkBooleanField("male","find field 'male'","no field 'male'");
        checkDoubleField("weight","find field 'weight'","no field 'weight'");


        System.out.println(checkConstructor("", "no method 'Man()'", new Runnable() {
            @Override
            public void run() {
        ...
        dispRetObjects(checkConstructor("", "no method 'Man(String name, int age, boolean male, double weight)'",
                new Class[] { String.class,int.class,boolean.class,double.class},
                new Object[]{"Irina",14,true,45.4},new Object[]{"Petr",19,false,85.4},
                new Runnable() {
                    @Override
                    public void run() {
        ...
        checkMethod("setAge","","no method 'setAge(int a)'",
                new Class[] { int.class},
                new Object[]{20},new Object[]{16},
                new Runnable() {
                    @Override
                    public void run() {
                        System.out.println(rect);
        ...
        checkMethod("setWeight","","no method 'setWeight(double a)'",
                new Class[] { double.class},
                new Object[]{60.12},new Object[]{52.1},
                new Runnable() {
                    @Override
                    public void run() {
                        System.out.println(rect);
