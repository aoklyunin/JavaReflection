 ...
 */
public class ReflectionMyPolynom {
    static MyPolynom rect = new MyPolynom();
    static MyPolynom rect2 = new MyPolynom();
    ...
    static void setFieldInterhited(String fieldName, String yesString, String noString, double[] fieldVal1, double[] fieldVal2) {
        try {
            Class class_var = rect.getClass();
    ...
    public static void main(String[] args) {
        double [] carr1 = {1,2,5};
        double [] carr2 = {1.5,1,1};
        setFieldInterhited("cArr","","",carr1,carr2);
        double [] xarr1 = {1,2};
        double [] xarr2 = {0.5,1};
        setFieldInterhited("xArr","","",xarr1,xarr2);


        System.out.println(checkConstructor("", "no method 'MyPolygon()'", new Runnable() {
            @Override
            public void run() {
        ...
        dispRetObjects(checkConstructor("", "no method 'MyPolygon(double [] cArr, double [] xArr)'",
        ...
        dispRetObjects(checkConstructor("", "no method 'MyPolygon(double c0, double c1, double c2, double x0, double x1)'",
        ...
        dispRetObjects(checkMethod("solve","", "no method 'solve(double [] cArr, double [] xArr)'",
               new Runnable() {
                    @Override
                    public void run() {
